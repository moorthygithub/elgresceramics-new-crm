import { fetchSalesReturnById, updatePurchaseReturnEdit } from "@/api";
...
import { ArrowLeft, MinusCircle, SquarePlus, Trash2 } from "lucide-react";
  ...
  const deleteProductMutation = useMutation({
    mutationFn: async (productId) => {
      ...
      const response = await fetch(
        `${BASE_URL}/api/sales-return-sub/${productId}`,
        {
          method: "DELETE",
          headers: {
              ...
              <div className="flex items-center px-4 py-5 relative z-10">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs text-yellow-100 mt-0.5 opacity-90">
                    Modify existing dispatch return details
                  </p>
                </div>
              </div>
            </div>
