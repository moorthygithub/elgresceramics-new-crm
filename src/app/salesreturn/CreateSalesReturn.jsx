import { SALES_RETURN_CREATE } from "@/api";
...
const createBranch = async (data) => {
  ...
  const response = await fetch(`${SALES_RETURN_CREATE}`, {
    method: "POST",
    headers: {
...
const CreateSalesReturn = () => {
  ...
  const { data: salesRef } = useFetchSalesReturnRef();
                    ...
                    <MemoizedSelect
                      ...
                      options={
                        salesRef
                          ? [
                              {
                                value: salesRef.sales_ref,
                                label: salesRef.sales_ref,
                              },
                            ]
                          : []
                      }
